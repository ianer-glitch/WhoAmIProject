...
const internalExperienceList: Array<ExperienceItemProps> = [
  ...
  new ExperienceItemProps('VueJs', `1,8 ${yearsString}`, 'vue-js-icon.svg'),
  new ExperienceItemProps('PrimeVue', `1,8 ${yearsString}`, 'primevue-logo.svg'),
  new ExperienceItemProps('JavasScript', `1,8 ${yearsString}`, 'js-logo.svg'),
  ...
  new ExperienceItemProps('Google Protobuf', `6 ${months}`, 'protobuff.png.pro'),
